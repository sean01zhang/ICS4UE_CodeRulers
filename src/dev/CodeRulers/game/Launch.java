...
public class Launch {
    ...
    //creates new game object
        ...
        AbstractRuler[] r = {new BullyBot(),new BullyBot(),new BullyBot(),new BullyBot(), new DefendBot(), new SeanBot(), new UnknownBot(), new UnknownBot(), new UnknownBot(), new UnknownBot(),new RandomBot()};
